...
typedef uint32_t recs_component_type;
...
int recs_component_register(struct recs *recs, recs_component_type type, uint32_t max_components, size_t comp_size);
void* recs_component_get(struct recs *recs, recs_component_type c, uint32_t index);



void recs_system_register(struct recs *recs, recs_system_func func, enum recs_system_type type);
...
void recs_entity_add_component(struct recs *recs, recs_entity e, recs_component_type comp_type, void *component);
void recs_entity_add_tag(struct recs *recs, recs_entity e, recs_tag tag);

void recs_entity_remove_component(struct recs *recs, recs_entity e, recs_component_type comp_type);
...
int recs_entity_has_component(struct recs *recs, recs_entity e, recs_component_type c);
int recs_entity_has_tag(struct recs *recs, recs_entity e, recs_tag tag);

void* recs_entity_get_component(struct recs *recs, recs_entity e, recs_component_type c);
